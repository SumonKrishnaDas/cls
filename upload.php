...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Eclassroom/assets/images/profilePics';
	//Set File name	
...
<div id="formExample">
	...
	<form action="upload.php" method="post"  enctype="multipart/form-data" class="box-text">
...
if($imgSrc){ //if an image has been uploaded display cropping area?>
	...
	<div id="CroppingContainer" class="box-color" style="width:800px; max-height:600px; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
		...
		<div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
		   <p style="margin:0px; padding:0px; color:#444; font-size:18px;">          
				<b class="box-text">Crop Profile Image</b><br /><br />
				<span style="font-size:10px;" class="box-text" >
